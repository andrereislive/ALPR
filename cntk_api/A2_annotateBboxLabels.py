...
# Parameters
####################################
imagesToAnnotateDir = "D:/Django-Workspace/ALPR/ALPR/cntk_api/data/PlateDS/positive"
...
for imgIndex, imgFilename in enumerate(imgFilenames):
    ...
    for rectIndex,rect in enumerate(rects):
        imgCopy = img.copy()
        drawRectangles(imgCopy, [rect], thickness = 4)
...
tk.destroy()
if boNoImgFound == True:
    print("Images not found in:"+ imagesToAnnotateDir)
